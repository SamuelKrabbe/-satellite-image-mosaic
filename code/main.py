...
x_se, y_se, x_id, y_id = map(int, input("Digite a coordenada da imagen: ").split())

# Criando um loop para ler as próximas coordenadas e definir o retângulo mínimo
while True:
    try:
        x1, y1, x2, y2 = map(int, input("Digite a coordenada da imagen: ").split())
...
print("({}, {}), ({}, {})".format(x_se, y_se, x_id, y_id))
